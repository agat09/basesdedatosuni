...
class PDF extends FPDF
{
        ...
        where profesor.idProfesor = '$Docente' and asignaturas.idAsignatura = '$Asignatura' and grupo.idGrupo = '$Grupo' and horarios.idHorario = '$Horario' and asignaciones.NumeroAsignacion = '$Numero'");
