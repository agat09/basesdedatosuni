...
class PDF extends FPDF
{
		function Header()
		{
		    ...
		    $this->Cell(20,20,'Material Didactico del Profesor:',0,0,'L');
		    $codigo = $_SESSION["Codigo"];
...
where material_didactico.idProfesor = '$codigo'");
