...
mysqli_query($conex,"DELETE FROM evaluaciones WHERE idEvaluacion = '$id'");
...
FROM profesor INNER JOIN evaluaciones ON  profesor.idProfesor =  evaluaciones.idProfesor 
        ...
        INNER JOIN grupo ON  estudiantes.idGrupo =  grupos.idGrupo 
        INNER JOIN asignaturas ON  evaluaciones.idAsignatura =  asignaturas.idAsignatura
where  profesor.idProfesor = '$codigo' ORDER BY evaluaciones.idEvaluacion ASC");
