    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        ...
        <ul class="navbar-nav ml-auto">
            	<li class="dropdown">
						...
						<img class="img-responsive img-circle" src="<?php echo $foto ?>" width="30px" height="30px" >
								<span class="navbar-user-img online pull-right">
									
									<i class="ti-user"><h5 style="color:#1D809F;"><b> &nbsp; Online: </b><?php echo $profesor ?></h5></i>
								</span>								
								<span class="hidden-xs "><i class="fa fa-circle  fa-inverse" style="color:green; text-align: "></i></span>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Ver Tareas de Estudiantes</li>
            </ol>
        </div>
