...
<head>
    ...
    <script type="text/javascript" src="asignaturas/myjava.js"></script>
        ...
        <!--********************************************************************************************************-->
         ...
         <div class="card border-primary">
                        <div class="card header bg-primary">
                            ...
                            <center>
                                <h4><b>Administracion de Asignaturas</b></h4>
                            </center>
                        </div>
                        <br>
                        <br>
                                ...
                                <div class="col-md-6">
                                    <center>
                                        <h4 style="font-weight: bold;">
                                            <?php
include('conex.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conex, "SELECT * FROM asignaturas"));
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header" style="background:#0a2048; text-align: center;">
                                                <h4 class="modal-title" style="color:white;" id="myModalLabel"><b>
                                                        <i class='fa fa-tasks'></i>&nbsp;&nbsp;Asignaturas</b></h4>
