...
<head>
    ...
    <script type="text/javascript" src="numeros_asignaciones/myjava.js"></script>
        ...
        <div class="card-body">
            <div class="row">
		               ...
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Numero de Asignacion">
		               	...
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="fa fa-plus"></i> Nuevo Numero de Asignacion</button>
		               </div>
	              <br>
 <br>
...
include('conex.php');
    ...
    <div class="modal fade" id="registra-datos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
              ...
              <i class='fa fa-sort-by-order'></i>&nbsp;&nbsp;Numeros de Asignacion Profesor</b></h4>
            </div>
