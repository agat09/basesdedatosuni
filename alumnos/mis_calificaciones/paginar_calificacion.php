...
$conex = mysqli_connect("myserveruni.mysql.database.azure.com", "agat@myserveruni", "Uni095359", "bd");
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query($conex,"SELECT evaluaciones.Descripcion as Descripcion, asignaturas.NombreAsignatura as Asignatura, evaluaciones.Unidad as Unidad, evaluaciones.Tarea as Tarea,  concat (profesor.NombresProfesor, ' ' ,profesor.ApellidosProfesor) as Profesor, 
