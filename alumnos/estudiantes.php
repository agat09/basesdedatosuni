...
<div class="" align="center">
    <center>
        ...
        <!-- Content Column -->
        <div class="card border-primary">
            <h3><b>Bienvenido Estudiante :</b> <b style="color:green;">
                    <?php echo $estudiante; ?></b></h3>
            <p>En esta seccion del sistema usted podra visualizar y estudiar todas las unidades de las asignatura <b>Bases de datos</b>, ademas podra descargar los archivos de apoyo de las clases impartidas, entregar tareas y ver las notas asignadas a estas tareas.</p>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            <h4>Unidades</h4>
                            <a href="Unidades.php" class="btn btn-primary"> <i class="fa fa-download"></i> Entrar</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        <div class="panel-heading">
                            <span class="fa-stack fa-5x">
                                <img src="images/mes.jpg" class="img-responsive" width="100" height="100">
                            </span>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        <div class="panel-heading">
                            <span class="fa-stack fa-5x">
                                <img src="images/tas2.jpg" class="img-responsive" width="100" height="100">
                            </span>
                        </div>
                        <div class="panel-body">
                            <h4>Tareas Asignadas</h4>
                            <a href="tareas_recibidas.php" class="btn btn-primary"><i class="fa fa-download"></i> Entrar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="entrega_tarea.php" class="btn btn-primary"><i class="fa fa-download"></i> Entrar</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="mis_calificaciones.php" class="btn btn-primary"><i class="fa fa-download"></i> Entrar</a>
                        </div>
                    </div>
                </div>
