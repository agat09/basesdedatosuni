...
<div id="Updatepicture" class="modal fade" role="dialog" >
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <a class="navbar-brand" href="index.html"> Bases de Datos  </a>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <div class="carousel-item active">
            <img class="rounded mx-auto d-block" src="../images/a.jpg" alt="Responsive image" width="60%">
        </div>
        <div class="carousel-item">
           <img class="rounded mx-auto d-block" src="../images/a.jpg" alt="Responsive image" width="60%">
        </div>
        <div class="carousel-item">
            <img class="img-fluidrounded mx-auto d-block" src="../images/a.jpg" alt="Responsive image" width="60%">
        </div>
        </div>
    ...
    <table class="table" >
        <tbody>    
               ...
               <thead>
                ...
                <div class="dropdown show" >
                    ...
                    <div class="card text-white bg-primary  o-hidden h-100">
                     ...
                     <div class=" text-white bg-primary o-hidden h-100">    
                        <button type="button" class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" color="" >
                          ...
                          <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="unidades/unidad1-1.php" aling="center">CONTENIDOS:</a>
                              <a class="dropdown-item" href="unidades/unidad1-1.php">1.1	Panorama de un sistema de bases de datos</a>
                    ...
                    <div class="card text-white bg-primary  o-hidden h-100">
                     ...
                     <div class=" text-white bg-primary o-hidden h-100">    
                        <button type="button" class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                          ...
                          <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                              <a class="dropdown-item" href="#" aling="center">CONTENIDOS:</a>
                ...
                <td style="width: 398.152%; height: 80px;">&nbsp; <p aling="Justify" aling-text="center" ><b>Definir las operaciones del algebra relacional y los tres lenguajes que son parte de Transact SQL a través del gestor de bases de datos SQL Server </b></p></td>
                </tr>
