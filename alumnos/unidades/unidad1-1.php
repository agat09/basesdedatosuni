            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <p ALIGN="justify">2. Oportunidad: tiempo transcurrido desde el momento en que se produjo el hecho que originó el dato, hasta el momento en el que la información se pone a disposición del usuario.</p>

                        <p ALIGN="justify">3. Compleción: significa que la información ha de ser completa para poder cumplir sus fines.
                        ...
                        <p ALIGN="justify">4. Significado: debe poseer el máximo contenido semántico posible (significado inherente de los datos)e, ya que sin él no constituiría verdadera información. Un volumen de información justo es condición indispensable para que ésta sea significativa.</p>

                        <p ALIGN="justify">5. Integridad: toda la información contenida en el sistema debe ser coherente en sí misma; esta cualidad coincide en parte con el concepto de precisión.</p>

                        <p ALIGN="justify">6. Seguridad: la información ha de estar protegida frente a su deterioro (por causas físicas o lógicas) como frente a accesos no autorizados. Actualmente el concepto de seguridad comprende confidencialidad, disponibilidad e integridad.</p>
