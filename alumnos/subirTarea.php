        ...
        <div class="card border-primary" align="center">
            ...
            <div class="panel panel-primary">
                <div class="card header bg-primary">
                    ...
                    <center>
                        <h4><b>Nueva Entrega de Tarea</b></h4>
                    </center>
                </div>
                ...
                <div class="card-body" align="center">
                    <div class="row">
                        <div style="#" align="center">
                            <form id="formulario" class="form-group" action="entrega_tareas/recibirSubida.php" method="post" enctype="multipart/form-data" align="center">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row"> <label for="carrera" class="col-md-3 control-label">Codigo Docente:</label>
                                        <div class="col-md-9"><input type="text" class="form-control" id="codigoD" name="codigoD" required="true" maxlength="50"></div>
                                    </div> <br>

                                    <div class="form-group row"> <label for="carnet" class="col-md-3 control-label">Asignatura:</label>
                                        <div class="col-md-9">
                         ...
                         echo "<option value='".$fila['0']."'>".$fila['1']."</option>";
                          ...
                          ?>
                                    ...
                                    <div class="form-group row"> <label for="carnet" class="col-md-3 control-label">Archivo:</label>
